...
PATH_TO_DB = pathlib.Path(__file__).absolute().joinpath(f'../{SERVER_DB}')
# print(PATH_TO_DB)
...
class ServerDB:
    ...
    def __init__(self):
        self.engine = create_engine(f'sqlite:///{PATH_TO_DB}', echo=False, pool_recycle=7200)
    ...
    def client_history_list(self, username=None):
...
if __name__ == '__main__':
    ...
    # print(db.users_list())
    # print(db.client_history_list()[0])
